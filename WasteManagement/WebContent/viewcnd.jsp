...
<!--heder end here-->
<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.html">Home</a><i class="fa fa-angle-right"></i>View CND Request</li>
            </ol>
...
<tr>
    ...
    <td><a href="approve.jsp?id=<%= rs.getInt("number")%>">Approve</a></td>
     <td><a href="disapprove.jsp?id=<%= rs.getInt("number")%>">Disapprove</a></td>
      <td><a href="completed.jsp?id=<%= rs.getInt("number")%>">Completed</a></td>
  </tr>
